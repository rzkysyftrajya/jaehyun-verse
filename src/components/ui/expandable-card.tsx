      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card) => (
          <motion.li
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-center bg-secondary/30 hover:bg-secondary/50 rounded-xl cursor-pointer"
          >
            <div className="flex gap-4 flex-col md:flex-row items-center">
              ...
              <div>
                <motion.h3
                  ...
                  className="font-medium text-primary-foreground text-center md:text-left"
                >
                  {card.title}
                </motion.h3>
                <motion.p
             ...
             <motion.div layoutId={`button-${card.title}-${id}`}>
                <Button className="px-4 py-2 text-sm rounded-full font-bold bg-primary/20 hover:bg-primary/40 text-primary-foreground mt-4 md:mt-0">
                    {card.ctaText}
                </Button>
            </motion.div>
          </motion.li>
