...
import { Home, Heart, Calendar, Wand2, BookHeart, Gamepad2 } from 'lucide-react';
import { cn } from '@/lib/utils';
import GlassCard from './shared/glass-card';

const navItems = [
  { href: '/', label: 'Home', icon: Home },
  { href: '/daily', label: 'Daily Jaehyun', icon: Calendar },
  { href: '/hearts', label: 'Heart Collector', icon: Heart },
  { href: '/games', label: 'Game Center', icon: Gamepad2 },
  { href: '/creative', label: 'Creative Corner', icon: Wand2 },
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive ? "bg-primary/30 text-primary-foreground shadow-inner" : "text-muted-foreground"
      )}
    >
