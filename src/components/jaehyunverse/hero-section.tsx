...
const GlitchText = ({ text }: { text: string }) => (
  <div className="relative glitch-text text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black font-headline tracking-tighter" data-text={text}>
    {text}
  </div>
);

const FloatingImage = ({ src, alt, className, style, dataAiHint, width, height }: { src:string; alt: string; className: string; style?: React.CSSProperties, dataAiHint: string, width: number, height: number }) => (
  ...
  return (
    <div className="relative w-full h-screen flex flex-col justify-center items-center text-center overflow-hidden p-4">
      <div className="relative w-full h-full max-w-5xl">
        <FloatingImage 
          src="https://picsum.photos/seed/jaehyun-hero1/400/600"
          alt="Jaehyun photo 1" 
        ...
        />
        <FloatingImage 
          src="https://picsum.photos/seed/jaehyun-hero2/400/600"
          alt="Jaehyun photo 2"
        ...
        />
         <FloatingImage 
          src="https://picsum.photos/seed/jaehyun-hero3/600/400"
          alt="Jaehyun photo 3" 
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center bg-background/30 backdrop-blur-[2px]">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-md">
          An interactive wonderland dedicated to the one and only Jeong Jaehyun.
        </p>
      </div>
    </div>
  );
