...
const story: Story = {
  start: {
    image: 'https://picsum.photos/seed/date-start/800/600',
  ...
  americano: {
    image: 'https://picsum.photos/seed/date-coffee/800/600',
  ...
  smoothie: {
    image: 'https://picsum.photos/seed/date-smoothie/800/600',
  ...
  bookstore: {
    image: 'https://picsum.photos/seed/date-bookstore/800/600',
    ...
    bookstore_fiction: {
    image: 'https://picsum.photos/seed/date-fiction/800/600',
    ...
    choices: [
        { text: 'Terima kasih, Jaehyun!', nextScene: 'dinner_intro' }
    ],
  },
  bookstore_poetry: {
    image: 'https://picsum.photos/seed/date-poetry/800/600',
    ...
    choices: [
        { text: '(Tersipu malu)', nextScene: 'dinner_intro' }
    ],
  },
  dinner_intro: {
      image: 'https://picsum.photos/seed/date-hungry/800/600',
  ...
  dinner_quiet: {
      image: 'https://picsum.photos/seed/date-dinner/800/600',
      ...
      choices: [{ text: 'Akhiri kencan intelektual ini', nextScene: 'bookstore_ending' }],
  },
  bookstore_ending: {
      image: 'https://picsum.photos/seed/date-end-book/800/600',
  ...
  park_talk: {
      ...
      choices: [
          ...
          { text: '"Momen ini. Saat kita ngobrol santai."', nextScene: 'photobooth_intro' }
      ]
  },
  park_photo: {
      ...
      choices: [
          { text: 'Tentu saja!', nextScene: 'photobooth_intro' }
      ]
  },
  photobooth_intro: {
  ...
  jacket_moment: {
      ...
      choices: [{ text: 'Akhiri kencan mendebarkan ini', nextScene: 'movie_ending' }],
  },
  movie_ending: {
...
export default function VirtualDateGame() {
  ...
  return (
    <GlassCard id="virtual-date-card" className="w-full max-w-2xl p-0 overflow-hidden transition-opacity duration-300">
